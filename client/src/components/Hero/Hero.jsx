...
export const Hero = () => {
    return (
        <div className="min-h-[75vh] bg-zinc-900 items-center justify-center flex flex-col md:flex-row">
            <div className="mt-4 w-full flex flex-col items-center justify-center px-8 lg:w-3/6 lg:items-start">
